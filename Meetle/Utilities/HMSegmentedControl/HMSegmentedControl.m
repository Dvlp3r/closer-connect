...
- (void)commonInit {
    ...
    self.badgeScrollView = [[HMScrollView alloc] init];
    self.badgeScrollView.delegate=self;
    self.badgeScrollView.scrollsToTop = NO;
    self.badgeScrollView.showsVerticalScrollIndicator = NO;
    self.badgeScrollView.showsHorizontalScrollIndicator = NO;
    [self addSubview:self.badgeScrollView];
...
- (void)updateSegmentsRects {
    ...
    self.badgeScrollView.contentInset = UIEdgeInsetsZero;
    ...
    self.badgeScrollView.contentSize = CGSizeMake([self totalSegmentedControlWidth], self.frame.size.height);
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    {
        self.badgeScrollView.contentOffset=scrollView.contentOffset;
    }
    else if (scrollView==self.badgeScrollView)
    {
...
- (void)scrollToSelectedSegmentIndex:(BOOL)animated {
    ...
    [self.badgeScrollView scrollRectToVisible:rectToScrollTo animated:animated];
}
...
- (NSDictionary *)resultingSelTitleTextAttributes {
    NSDictionary *defaults = @{
                               NSFontAttributeName : [UIFont systemFontOfSize:14.0f],
...
- (NSDictionary *)resultingSelectedTitleTextAttributes {
    NSMutableDictionary *resultingAttrs = [NSMutableDictionary dictionaryWithDictionary:[self resultingSelTitleTextAttributes]];
